...
import com.ricardocenteno.alltrailsplaces.di.NetworkModule_ProvidePlaceMapperFactory;
import com.ricardocenteno.alltrailsplaces.di.NetworkModule_ProvidePlacesServiceFactory;
import com.ricardocenteno.alltrailsplaces.di.RepositoryModule;
import com.ricardocenteno.alltrailsplaces.di.RepositoryModule_ProvideRecipeRepositoryFactory;
...
import com.ricardocenteno.alltrailsplaces.view.activities.MainActivity;
import com.ricardocenteno.alltrailsplaces.view.fragments.MapPlacesFragment;
...
import com.ricardocenteno.alltrailsplaces.viewmodels.PlacesViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC extends BaseApplication_HiltComponents.SingletonC {
  ...
  private Provider<PlaceDtoMapper> providePlaceMapperProvider;

  private Provider<PlaceRepository> provideRecipeRepositoryProvider;
  ...
  private PlaceRepository placeRepository() {
    return RepositoryModule_ProvideRecipeRepositoryFactory.provideRecipeRepository(providePlacesServiceProvider.get(), providePlaceMapperProvider.get());
  }

  @SuppressWarnings("unchecked")
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    this.providePlacesServiceProvider = DoubleCheck.provider(new SwitchingProvider<PlacesService>(singletonC, 1));
    this.providePlaceMapperProvider = DoubleCheck.provider(new SwitchingProvider<PlaceDtoMapper>(singletonC, 2));
    this.provideRecipeRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PlaceRepository>(singletonC, 0));
  }
  ...
  private static final class FragmentCImpl extends BaseApplication_HiltComponents.FragmentC {
    ...
    @Override
    public void injectMapPlacesFragment(MapPlacesFragment mapPlacesFragment) {
    }

    @Override
    public void injectPlaceListFragment(PlaceListFragment placeListFragment) {
    }
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(PlacesViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    private PlacesViewModel placesViewModel() {
      return new PlacesViewModel(singletonC.provideRecipeRepositoryProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.placesViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.ricardocenteno.alltrailsplaces.viewmodels.PlacesViewModel", (Provider) placesViewModelProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ricardocenteno.alltrailsplaces.viewmodels.PlacesViewModel 
          return (T) viewModelCImpl.placesViewModel();
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.ricardocenteno.alltrailsplaces.model.repository.PlaceRepository 
        return (T) singletonC.placeRepository();

        case 1: // com.ricardocenteno.alltrailsplaces.model.network.PlacesService 
        return (T) NetworkModule_ProvidePlacesServiceFactory.providePlacesService();

        case 2: // com.ricardocenteno.alltrailsplaces.model.network.PlaceDtoMapper 
        return (T) NetworkModule_ProvidePlaceMapperFactory.providePlaceMapper();
