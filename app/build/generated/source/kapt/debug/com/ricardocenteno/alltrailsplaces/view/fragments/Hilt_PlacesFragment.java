...
public abstract class Hilt_PlacesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlacesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlacesFragment_GeneratedInjector) this.generatedComponent()).injectPlacesFragment(UnsafeCasts.<PlacesFragment>unsafeCast(this));
    }
  }
