...
public abstract class Hilt_PlaceListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlaceListFragment() {
    super();
  }

  Hilt_PlaceListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaceListFragment_GeneratedInjector) this.generatedComponent()).injectPlaceListFragment(UnsafeCasts.<PlaceListFragment>unsafeCast(this));
    }
  }
