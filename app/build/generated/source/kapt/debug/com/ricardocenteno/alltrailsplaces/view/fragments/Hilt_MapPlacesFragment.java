...
public abstract class Hilt_MapPlacesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MapPlacesFragment() {
    super();
  }

  Hilt_MapPlacesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapPlacesFragment_GeneratedInjector) this.generatedComponent()).injectMapPlacesFragment(UnsafeCasts.<MapPlacesFragment>unsafeCast(this));
    }
  }
